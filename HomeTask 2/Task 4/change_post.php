...
<body>
    ...
    <div class="container my-5">
        <h2>Чтобы изменить пост добавьте get параметр id в адресную строку</h2>
        <form action="" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="titleInput" name="date" placeholder="dd.mm.yyyy" value="<?= $post['date'] ?>">
            </div>
